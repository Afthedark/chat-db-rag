"""
Models module for LLM configuration and communication.
Handles Ollama and Gemini API interactions.
"""
...
class OllamaClient:
    ...
    def query(self, model: str, messages: List[Dict[str, str]], 
        ...
        print(f"[Ollama] Context limit: {OLLAMA_CONTEXT_LIMIT}")
...
class GeminiClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if self._available and api_key:
